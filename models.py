...
# get the pretrained embedding vectors of the dictionary of ID of each token using word2vec model
def get_pretrained_emb(word2vec, token2id): 
    ...
    pretrained_emb = np.zeros((len(token2id), 300)) # restrict each token is a vector of dimension 300.
